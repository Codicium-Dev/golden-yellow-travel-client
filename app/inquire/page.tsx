...
const page = () => {
  ...
  return (
    <>
      <div className="pt-[110px] md:pt-[140px] pb-[40px] bg-[#efefef] open-sans">
        <h1 className="pb-5 text-2xl lg:text-3xl font-semibold tracking-widest text-[#464646] text-center uppercase">
          Customize Your Tour
        </h1>
        <p className="text-base lg:text-lg text-gray-500 px-6 text-center mx-auto mb-10">
        ...
        <div className=" grid grid-rows-4 w-4/5 mx-auto gap-5 mb-12">
          ...
          <div className=" row-start-1 row-span-1 grid grid-cols-4 gap-3 ">
            <div className=" col-start-1 col-span-12 md:col-span-1 px-3">
              <h1 className=" mb-2 font-semibold text-[#464646]">
                Travel Month *
              </h1>
              <select
                name=""
                id=""
                className=" w-full border border-[#1c94ad] px-3 py-2 rounded-lg"
        ...
        <div className=" grid grid-rows-4 w-4/5 mx-auto gap-1 mb-14">
          ...
          <div className=" row-start-2 row-span-1 grid grid-cols-2 gap-3">
            <div className=" col-start-1 col-span-1 px-3">
              <h1 className=" mb-2 font-semibold text-[#464646]">First Name</h1>
              <input
                type="text"
                id=""
                className=" w-full border border-[#1c94ad] px-3 py-2 rounded-lg"
            ...
            <div className=" col-start-2 col-span-1 px-3">
              <h1 className=" mb-2 font-semibold text-[#464646]">Last Name</h1>
              <input
                type="text"
                name=""
                id=""
          ...
          <div className=" row-start-3 row-span-1 grid grid-cols-2">
            <div className=" col-start-1 col-span-1 px-3">
              <h1 className=" mb-2 font-semibold text-[#464646]">Email</h1>
              <input
                type="text"
                name=""
                id=""
          ...
          <div className=" row-start-4 row-span-1 grid grid-cols-1">
            <div className=" col-start-1 col-span-1 px-3">
              <h1 className=" mb-2 font-semibold text-[#464646]">Country</h1>
              <input
                type="text"
                name=""
                id=""
        ...
        <div className=" grid grid-rows-3 w-4/5 mx-auto gap-5 mb-14">
          <div className=" row-start-1 row-span-3  grid md:grid-cols-2 grid-cols-12 gap-3">
            ...
            <div className=" md:col-start-2 md:col-span-1  col-start-1 col-span-12 px-3 grid grid-rows-6">
              <h1 className=" mb-2 font-semibold text-[#464646] row-start-1 row-span-1">
                Special requests?
              </h1>
              <textarea
                ...
                name=""
                id=""
                className=" w-full border border-[#1c94ad] px-3 py-2 rounded-lg row-start-2 row-span-5 h-5/6"
        ...
        <div className=" flex justify-center">
          <button
            ...
            // className=" rounded-lg bg-[#1c94ad] py-2"
            className="md:w-1/6 w-2/5 mt-4 lg:mt-0 py-2 text-center bg-[#1c94ad] rounded-md text-white font-bold text-base hover:bg-[#68e6ff] transition-colors"
          >
