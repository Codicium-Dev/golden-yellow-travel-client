...
const page = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className=" font-serif text-[#010e3b] lg:text-5xl text-4xl text-center mb-8">
          Customized Tour
        </h1>
        ...
        <div className="w-full max-w-[1000px] px-5 md:px-10 lg:px-[70px] mx-auto mb-10">
          <div className=" grid grid-cols-4 gap-3">
            <div className=" col-start-1 col-span-4 md:col-span-1">
              ...
              <select
                name=""
                id=""
                className=" w-full h-[38px] text-sm border border-[#010e3b] rounded-lg p-2 cursor-pointer"
                value={travelMonth}
            ...
            <div className=" col-start-1 md:col-start-2 col-span-4 md:col-span-1">
              ...
              <select
                name=""
                id=""
                className=" w-full h-[38px] text-sm border border-[#010e3b] rounded-lg p-2"
                value={travelYear}
