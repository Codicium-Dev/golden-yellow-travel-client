...
export const metadata: Metadata = {
  title: "Golden Asia Expedition - Privacy & Policy",
  description: "This is the privacy & Policy page of Golden Asia Expedition.",
  keywords: "Golden Asia Expedition, Privacy & Policy",
};
  ...
  return (
    <div className="pt-[90px] md:pt-[120px] pb-12 bg-[#E2F3FF] lg:px-12 px-8 open-sans">
      ...
      <div className="pb-2 flex flex-col gap-2">
        ...
        <ul className="pb-2 flex flex-col gap-2">
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Golden Asia Expedition, No. 69, 3rd
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Golden Asia Expedition,
              accessible from{" "}
              <a
      ...
      <div className="pb-2 flex flex-col gap-2">
        ...
        <ul className="pb-2 flex flex-col gap-2">
          <li>
            <p>By email: info@goldenyellowtravel.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://goldenyellowtravel.com/privacy-statement"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://goldenyellowtravel.com/privacy-statement
              </a>
            </p>
          </li>
        </ul>
